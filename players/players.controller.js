...
class PlayersController {
    async getAllPlayers(req, res) {
        ...
        if (usual_query === 'false') {
            players = await db.query(`select  pt.time, pg.game_id, pt.player_id from player_time as pt 
    ...
    async updatePlayer(req, res) {
        ...
        const players = await db.query('UPDATE players SET enabled = $1 WHERE id = $2 RETURNING *', [enabled, id])
    ...
    async createPlayer(req, res) {
        ...
        const players = await db.query('INSERT INTO players (id, username, first_name, last_name, enabled, was_created, invited_from) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *', [id, username, first_name, last_name, true, todayTimestamp, invited_from]);
