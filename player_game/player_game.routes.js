...
router_player_game.post(
  "/player_game",
  player_gameController.createPlayer_game
);
router_player_game.delete(
  "/player_game/:id",
  player_gameController.deletePlayer_game
);
router_player_game.delete(
  "/player_game",
  player_gameController.deleteAllPlayer_game
);
