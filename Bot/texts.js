...
const texts = {
    ...
    invitation: {
        ...
        2: `При первом запуске с новым пользователем мне нужно получить от него <b><u>твой код</u></b> — ему достаточно скопировать и отправить его ко мне в чат.`,
        3: `<b>Твой код (копируется автоматически при нажатии):</b>`
    },
    letsPlay: {
