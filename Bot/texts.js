...
const texts = {
    ...
    schedule_assemble: `<b>Ты можешь запланировать запуск опросов на любые нужные тебе день и время</b>, используя встроенный в Telegram функционал.\nДля этого набери команду <code>/assemble</code> (копируется при нажатии) и:\n<u>На телефоне</u> — удерживай палец на кнопке отправке сообщения и выбери <code>"Запланировать отправку"</code>\n<u>На компьютере</u> — нажми правой кнопкой мыши по кнопке отправке сообщения и выбери <code>"Запланировать отправку"</code>`,
