...
const texts = {
    ...
    forButtonFullReminder: `Ниже ты можешь задать время — за сколько Минут до начала событий тебе будет поступать <b>Общее расписание</b> с уведомлением о предстоящих играх`,
    forButtonPersonalReminder: `Ниже ты можешь задать время — за сколько Минут до начала событий тебе будет поступать <b>Персональное расписание</b> с уведомлением о предстоящих играх`,
    ...
    time_for_create: `Новые опросы можно создавать в промежутке <b>с ${start_time}:00 до ${end_time}:00</b> (по мск)`,
